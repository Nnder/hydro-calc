...
<template>
  <section class="max-w-8xl flex items-center py-8 md:py-16 px-4">
    <!-- <div class="text-center mb-8 md:mb-12">
      ...
      grid grid-cols-4 gap-4 md:gap-6 justify-center
    </div> -->
    ...
    >
      <AccessoriesItem
        ...
        :key="index"
        :item="item"
        class="w-full xl:w-full max-w-[350px] xl:max-w-[400px]"
      />
    </div>
  </section>
</template>