...
const sliders = [
  ...
  },
  {
    videoSrc: '/videos/Lavrov.mp4',
    img: '/hydrocilinder.png',
    title: 'Изготоаление рукава высокого давления (рвд)',
    // text: 'Регулярный сервис для бесперебойной работы',
  ...
  },
  {
    ...
    features: ['Диагностика за 2 часа', 'Гарантия до 12 месяцев', 'Проектирование и изготовление гидромотров'],
    buttonText: 'Оставить заявку',
    additionalInfo: 'Срочный ремонт за 24 часа',
  },
  {
    ...
    tag: 'Профессионально',
    title: 'Ремонт ковшей',
    text: 'Полный комплекс услуг по восстановлению ковшей',
    features: ['Диагностика за 2 часа', 'Гарантия до 12 месяцев', 'Проектирование и изготовление ковшей'],
    buttonText: 'Оставить заявку',
    additionalInfo: 'Срочный ремонт за 24 часа',
  },
  {
    ...
    features: ['Диагностика за 2 часа', 'Гарантия до 12 месяцев'],
    buttonText: 'Оставить заявку',
    additionalInfo: 'Срочный ремонт за 24 часа',
  },
]
