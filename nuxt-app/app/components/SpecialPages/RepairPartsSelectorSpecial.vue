        ...
        <section class="w-full md:flex-1 relative">
          <div class="w-full h-full rounded-2xl overflow-hidden relative flex items-center justify-center bg-gray-100 min-h-[400px] sm:min-h-[500px] md:min-h-[600px]">
            <div class="relative w-full h-full flex items-center justify-center" :style="props.imageStyle">
              ...
              >
                <div
                  v-if="part.highlight && (computedHighlightMode === 'single' ? activeHighlight === index : part.selected)"
...
const computedParts = computed(() => props.GlobalTable?.parts || props.parts)
...
const computedSelectorData = computed(() => props.GlobalTable?.selectorData !== undefined ? props.GlobalTable.selectorData : props.selectorData)
...
watch(() => computedMainImage.value, (newImage) => {
