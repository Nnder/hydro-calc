...
const blockDataText = {
  ...
  benefits: [
    ...
    'Указание объемов ремонта в паспорте на оборудование',
  ],
}
...
const globalTitle = ref({
  gtitle: 'Этапы ремонта Гидронасосов',
  subtitle: 'Полный цикл восстановления гидронасосов',
})
