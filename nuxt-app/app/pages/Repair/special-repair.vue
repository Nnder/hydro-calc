...
const sectionsData = {
  kovshi: {
    ...
    parameters: [
      ...
      { value: '12 месяцев', description: 'Гарантия на выполненные работы' },
    ],
...
<p>Наши технологии позволяют не просто восстановить геометрию ковша, но и значительно увеличить его износостойкость за счет применения специальных наплавочных материалов.</p>`,
  ...
  hydrovrashateli: {
    ...
    steps: [
      ...
      {
        title: 'Дефектовка',
        description: 'Тщательная проверка всех компонентов: ротора, распределителя, подшипников и планетарного механизма',
      },
      {
