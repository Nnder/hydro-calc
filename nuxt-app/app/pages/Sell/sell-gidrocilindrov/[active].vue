  ...
  products: [
    {
      ...
      description: [
        'Сильфоны для гидроцилиндров — это гибкие элементы, предназначенные для защиты подвижных деталей оборудования от загрязнений и внешнего воздействия.',
        'Они ограждают детали станков и промышленных роботов от попадания металлических стружек, окалины, пыли, агрессивных химических веществ, газов и паров, а также светового и теплового излучения.',
        'Сильфоны обеспечивают дополнительную защиту гидроцилиндров и других механизмов, снижая износ и продлевая срок службы рабочих компонентов. ',
        'Армированные стальными кольцами. Такие изделия имеют высокие прочностные показатели и защищают деталь не только от загрязнений, но и от механических повреждений.',
      ],
      gridItem: {
        image: '/silfons1.webp',
        title: 'Сильфоны',
    ...
    },
    {
      title: 'Пальцы',
      type: 'Пальцы',
      images: ['/palec.jpg', '/palets2.jpg', '/palci3.jpg'],
      parameters: [
        { label: 'Материал', value: 'Высокоуглеродистая сталь' },
        { label: 'Диаметр', value: 'от 20 мм до 150 мм' },
        { label: 'Точность изготовления', value: '8 Квалитет' },
        { label: 'Твердость наружного слоя', value: 'от 42 до 56 HRC' },
      ],
      description: [
        'Пальцы для гидроцилиндров — это цилиндрический стержень, который используется для соединения гидроцилиндра с другими частями машины или оборудования. ',
        'Он обеспечивает шарнирное соединение, позволяющее гидроцилиндру перемещать или толкать другие компоненты. ',
        'Основные функции пальца гидроцилиндра:',
        '- Передача усилия от гидроцилиндра к другим элементам;',
        '- Обеспечение подвижного соединения;',
        '- Предотвращение износа соединительных элементов;',
        '- Гарантия стабильной работы гидравлической системы.',
      ],
      gridItem: {
        image: '/palec.jpg',
        title: 'Пальцы',
    ...
    },
    {
      ...
      description: [
        'Втулка крепления гидроцилиндра — это деталь, которая обеспечивает надёжное крепление и передачу усилия от гидросистемы к рабочим органам машины.',
      ],
      gridItem: {
        image: '/vtulki1.jpeg',
        title: 'Втулки',
    ...
    },
    {
      ...
      parameters: [
        ...
        { label: 'Рабочее давление', value: 'до 40 МПа' },
      ],
      description: [
        'Гидролиния для экскаватора — это гидравлическая система, состоящая из трубопроводов, рукавов высокого давления, соединительных и крепёжных элементов, управляемая электрическим или гидравлическим способом.',
        'Основная функция гидролинии — возможность установки специализированного навесного гидрооборудования (гидромолота, бура, гидроножниц, грейферов, фрезы и подобных устройств).',
        'Некоторые виды гидролиний:',
        'Однопоточная. Подача гидравлической жидкости осуществляется в одном направлении. Используется для подключения гидромолота, вибротрамбовки.',
        'Двухпоточная. Подача гидравлической жидкости осуществляется в двух направлениях. Применяется для навесного оборудования — гидробура, грейфера, гидроножниц.',
    ...
    },
    {
      ...
      type: 'ГСМ',
      images: ['/vitex_maslo.png', '/nordfire_maslo.jpg', '/nordfire_maslo2.png'],
      parameters: [
        { label: 'Вязкость', value: 'от 15 до 46 сСт' },
        { label: 'Температура застывания', value: '-43°C' },
      ],
      description: [
        'Гидравлическое масло — это специальная жидкость, применяемая в гидравлических системах с целью передачи силы или для управления агрегатами и машинами.',
        'Основные функции гидравлических масел:',
        'Передача давления. Давление передаётся от одной точки системы к другой, что позволяет управлять движением и поднимать тяжести.',
        'Смазывание. Материал смазывает подвижные компоненты внутри гидравлических систем, что позволяет снизить трение и износ.',
        'Охлаждение. Масло охлаждает системы гидравлики, удаляя тепло, образующееся в результате высокого давления и трения.',
        'Гидравлические масла используют в различных областях, включая промышленное производство, строительную отрасль, транспорт и другие.',
      ],
      gridItem: {
        image: '/vitex_maslo.png',
