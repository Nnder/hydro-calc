...
<template>
  <div class="min-h-screen bg-white">
        ...
        <div class="max-w-4xl mx-auto text-center">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-6">
            <a href="tel:+78005553355" class="group flex items-center justify-center gap-3 text-white hover:text-blue-100 transition-colors">
             <div class="w-12 h-12 flex items-center justify-center bg-white/10 group-hover:bg-white/20 rounded-full transition-all">
    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-16">
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100" data-aos="fade-up" data-aos-delay="500">
          <div class="flex flex-col items-center text-center">
            <div class="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-lg mb-4">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100" data-aos="fade-up" data-aos-delay="550">
          <div class="flex flex-col items-center text-center">
            ...
            <a href="mailto:info@absolyut-tekno.ru" class="text-blue-600 hover:text-blue-700 text-lg font-semibold mb-2 block">
              info@absolyut-tekno.ru
            </a>
            <a href="mailto:sales@absolyut-tekno.ru" class="text-blue-600 hover:text-blue-700 text-lg font-semibold block">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100" data-aos="fade-up" data-aos-delay="600">
          <div class="flex flex-col items-center text-center">
            ...
            <h3 class="text-2xl font-bold mb-4 text-gray-900">Основные телефоны</h3>
        ...
        <div class="bg-white p-8 rounded-2xl shadow-lg border border-blue-100" data-aos="fade-up" data-aos-delay="650">
          <div class="flex flex-col items-center text-center">
           <div class="w-16 h-16 flex items-center justify-center bg-blue-100 rounded-lg mb-4">
            <Icon name="mdi:tools" class="w-8 h-8 text-blue-600" />
          </div>

            <h3 class="text-2xl font-bold mb-4 text-gray-900">Технические отделы</h3>
            <div class="space-y-3 w-full">
              <div>
                <p class="font-medium text-gray-900 mb-1">Техподдержка</p>
                <a href="tel:+78005553357" class="text-blue-600 text-lg font-semibold hover:text-blue-700">+7 (800) 555-33-57</a>
              </div>
              <div>
                <p class="font-medium text-gray-900 mb-1">Сервисный центр</p>
                <a href="tel:+78005553358" class="text-blue-600 text-lg font-semibold hover:text-blue-700">+7 (800) 555-33-58</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-blue-50 p-8 rounded-2xl border border-blue-200 mb-16" data-aos="fade-up" data-aos-delay="700">
        <h3 class="text-3xl font-bold mb-8 text-gray-900 text-center">Часы работы</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="text-center p-6 bg-white rounded-xl border border-blue-100">
            <Icon name="mdi:office-building" class="w-8 h-8 text-blue-600 mb-3 mx-auto" />
            <h4 class="font-semibold text-gray-900 mb-2">Офис</h4>
            <p class="font-semibold text-gray-900">Пн-Пт: 9:00-18:00</p>
            <p class="text-gray-600 text-sm">Сб-Вс: Выходной</p>
          </div>
          <div class="text-center p-6 bg-white rounded-xl border border-blue-100">
            <Icon name="mdi:tools" class="w-8 h-8 text-blue-600 mb-3 mx-auto" />
            <h4 class="font-semibold text-gray-900 mb-2">Сервисный центр</h4>
            <p class="font-semibold text-gray-900">Пн-Сб: 8:00-20:00</p>
            <p class="text-gray-600 text-sm">Вс: 9:00-17:00</p>
          </div>
          <div class="text-center p-6 bg-white rounded-xl border border-blue-100">
            <Icon name="mdi:headset" class="w-8 h-8 text-blue-600 mb-3 mx-auto" />
            <h4 class="font-semibold text-gray-900 mb-2">Техподдержка</h4>
            <p class="font-semibold text-gray-900">Пн-Сб: 8:00-20:00</p>
