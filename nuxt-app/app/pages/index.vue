...
useHead({
  title: `Ремонт продажа и изготовление гидравлики`,
  meta: [
    {
      name: 'description',
      content: `ООО АбсолютТехно Торгово-промышленная компания по ремонту, продаже и изготовлении гидравлики, навестного оборудования, строительного оборудования и электростанций. `,
    },
  ],
})
