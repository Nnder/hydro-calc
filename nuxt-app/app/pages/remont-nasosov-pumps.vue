...
const repairSteps = ref([
  ...
  },
  {
    ...
    description: 'Аккуратная разборка гидронасоса, тщательная мойка всех деталей и дефектовка компонентов',
  ...
  },
  {
    ...
    description: 'Приобретаем оригинальные запчасти и изготавливаем недостающие элементы: плунжеры, роторы, поршни и уплотнения',
    image: '/icons/gears.svg',
  },
  {
    title: 'Восстановление',
    shortDescription: 'Ремонт деталей',
    description: 'Проводим шлифовку валов, восстановление рабочих поверхностей, замену изношенных деталей и ревизию корпусных частей',
