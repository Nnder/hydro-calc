...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: `Каталог товаров. Большой ассортимент строительного оборудования, гидравлики и электростанций`,
    },
  ],
})
