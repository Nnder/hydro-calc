  ...
  <div class="bg-tech-light">
    <div class="w-4/5 mx-auto py-8 md:py-6 px-4 sm:px-3 lg:px-4 rounded-2xl mt-8 mb-4">
      <section class="mb-4 text-center">
        <h1 class="text-4xl sm:text-5xl font-bold mb-6 text-hydro-power">Профессиональный ремонт <br />гидромоторов</h1>
        <p class="text-xl text-hydro-steel/80 max-w-3xl mx-auto leading-relaxed">
          Компания «СДМ Гидравлика» — лидер в ремонте гидромоторов для спецтехники и промышленного оборудования в Москве
          и области.
        </p>
      </section>
      ...
      <section class="mb-2 relative">
        ...
        >
          <NuxtImg
            ...
            alt="Профессиональный ремонт гидромоторов"
            loading="lazy"
            format="webp"
            quality="80"
            id="hydroImage"
      ...
      <section class="bg-white rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-3 md:mb-4 gap-2 md:gap-4">
          <div>
            ...
            <p class="text-sm md:text-base text-hydro-steel/70">Отметьте необходимые компоненты гидромоторы</p>
          </div>
          <div
...
const hydrantParts = ref([
  {
    ...
    show: false,
    description:
      'Полная диагностика гидромоторы с использованием современного оборудования для выявления всех дефектов.',
    features: [
  ...
  },
  {
    ...
    selected: false,
    show: false,
    description: 'Комплексная замена всех уплотнительных элементов гидромоторы.',
    features: [
